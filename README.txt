...
Nella cartella sono allegati il file 'requirements.txt' che contiene tutte le dipendenze necessarie al fine di girare i codici.
Vi sono due script di setup pronti all'uso: creeranno un ambiente virtuale ad hoc di nome "qaoa_env" con i pacchetti necessari.
Su Linux/macOS:
chmod +x setup.sh
./setup.sh
Su Windows:
setup.bat
oppure doppio clic su setup.bat
